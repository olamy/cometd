        ...
        stages {
          stage('Build CometD') {
            ...
            steps {
              ...
              recordCoverage name: "Coverage ${env.JDK}", id: "coverage-${env.JDK}", tools: [[parser: 'JACOCO',pattern: 'cometd-coverage/target/site/jacoco-aggregate/jacoco.xml']], sourceCodeRetention: 'LAST_BUILD',
